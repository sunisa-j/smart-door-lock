// Generated on 2015-06-01 using generator-ionic 0.7.3
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    compass: {
      ...
      dist: {
        options: {
          cssDir: '<%= yeoman.app %>/<%= yeoman.styles %>', // copy to app location in dist option (EDITED)
      ...
      dist: {
        files: [{
          ...
          src: [
            ...
            'templates/**/*.html',
            'fonts/*',
            'fonts/**/*' // include sub folder (EDITED)
          ]
        }, {
          expand: true,
